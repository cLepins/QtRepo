...
void ChatClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->messageRecieved((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        case 5: _t->connetToServer((*reinterpret_cast< std::add_pointer_t<QHostAddress>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<quint16>>(_a[2]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (_t _q_method = &ChatClient::messageRecieved; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void ChatClient::messageRecieved(const QString & _t1)
{
